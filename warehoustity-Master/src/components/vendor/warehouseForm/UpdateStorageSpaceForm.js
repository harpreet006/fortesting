...
const UpdateStorageSpaceForm = ({ warehouseId, viewMood }) => {
  ...
  const [type, settype] = useState("floorarea")
  const handleYes = (e) => {
  ...
  const handleCheck = (e) => {
    ...
    setCheckForm1({ ...checkForm1, [e.target.name + "1"]: e.target.value === "true" })
  }
            ...
            <div className="col-12">
              ...
              <Formik
                ...
                onSubmit={fields => {
                  ...
                  if (groundFloorCheck1 === false || type === "palletposition") {
                  ...
                  if (basementCheck1 === false || type === "palletposition") {
                  ...
                  if (firstFloorCheck1 === false || type === "palletposition") {
                  ...
                  if (secondFloorCheck1 === false || type === "palletposition") {
                  ...
                  // {
                  //   fields["totalAvailableSpace"]=((fields.availa_bleSpaces[0].availableSpaceDimension.length)*(fields.availableSpaces[0].availableSpaceDimension.breath)
                  ...
                  if (basementCheck || groundFloorCheck || firstFloorCheck || secondFloorCheck) {
                    dispatch(updateStorageSpace(fields))

                  } else {
                    setFloorError("Plese Select Floor")
                    setTimeout(() => {
                      setFloorError(null)
                    }, 5000)
                  }
                ...
                render={({ values, errors, status, onChange, setFieldValue, touched }) => {
                  ...
                  const fieldClassObj = (fieldName, isTrue = true) => {
                    return 'form-control form-control-sm bg-white px-4' + (isTrue ? (getIn(errors, fieldName) && getIn(touched, fieldName) ? ' is-invalid' : '') : '')
                    ...
                    <Form>
                      <div className="row bg-white rounded mx-0 col-xxxl-11">
                        <div className="form-group form-inline col-12 mb-3 mt-2">
                          ...
                          }} className="form-check common-radio-deep-blue mx-3">
                            ...
                            <tbody>
                              <tr>
                                <td className="w-160px py-1">
                                  <p className="my-2">Floor(in ft): <sup className="text-danger">*</sup></p>
                                </td>
                                <td className="col-auto py-1"></td>
                                <td className="col-auto py-1"></td>
                                <td className="w-150px py-1 text-nowrap">
                                  <div className="common-checkbox-deep-blue2 position-relative mb-2 mx-auto d-inline-block">
                                    <input
                                      disabled={values.storageType === "palletposition" || viewMood}
                                      name="basementCheck"
                                      onChange={(e) => {
                                        handleCheck(e)
                                        if (e.target.value === "false") {
                                          setFieldValue(`floors[${0}].floorDimension.length`, "")
                                          setFieldValue(`floors[${0}].floorDimension.breath`, "")
                                          setFieldValue(`floors[${0}].floorDimension.height`, "")

                                          setFieldValue(`availableSpaces[${0}].availableSpaceDimension.length`, "")
                                          setFieldValue(`availableSpaces[${0}].availableSpaceDimension.breath`, "")
                                          setFieldValue(`availableSpaces[${0}].availableSpaceDimension.height`, "")
                                        }
                                      }
                                      }
                                      value={!basementCheck} checked={basementCheck} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck1" />
                                ...
                                <td className="w-150px py-1 text-nowrap">
                                  <div className="common-checkbox-deep-blue2 position-relative mb-2 mx-auto d-inline-block">
                                    <input
                                      name="groundFloorCheck"
                                      onChange={(e) => {
                                        handleCheck(e)
                                        if (e.target.value === "false") {
                                          setFieldValue(`floors[${1}].floorDimension.length`, "")
                                          setFieldValue(`floors[${1}].floorDimension.breath`, "")
                                          setFieldValue(`floors[${1}].floorDimension.height`, "")

                                          setFieldValue(`availableSpaces[${1}].availableSpaceDimension.length`, "")
                                          setFieldValue(`availableSpaces[${1}].availableSpaceDimension.breath`, "")
                                          setFieldValue(`availableSpaces[${1}].availableSpaceDimension.height`, "")
                                        }
                                      }}
                                      value={!groundFloorCheck}
                                      checked={groundFloorCheck} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck2" disabled={values.storageType === "palletposition" || viewMood} />
                                ...
                                <td className="w-150px py-1 text-nowrap">
                                  <div className="common-checkbox-deep-blue2 position-relative mb-2 mx-auto d-inline-block">
                                    <Field
                                      name="firstFloorCheck"
                                      onChange={(e) => {
                                        handleCheck(e)
                                        if (e.target.value === "false") {
                                          setFieldValue(`floors[${2}].floorDimension.length`, "")
                                          setFieldValue(`floors[${2}].floorDimension.breath`, "")
                                          setFieldValue(`floors[${2}].floorDimension.height`, "")

                                          setFieldValue(`availableSpaces[${2}].availableSpaceDimension.length`, "")
                                          setFieldValue(`availableSpaces[${2}].availableSpaceDimension.breath`, "")
                                          setFieldValue(`availableSpaces[${2}].availableSpaceDimension.height`, "")
                                        }
                                      }}
                                      value={!firstFloorCheck} checked={firstFloorCheck} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck3" disabled={values.storageType === "palletposition" || viewMood} />
                                ...
                                <td className="w-150px py-1 text-nowrap">
                                  <div className="common-checkbox-deep-blue2 position-relative mb-2 mx-auto d-inline-block">
                                    <Field
                                      name="secondFloorCheck"
                                      onChange={(e) => {
                                        handleCheck(e)
                                        if (e.target.value === "false") {
                                          setFieldValue(`floors[${3}].floorDimension.length`, "")
                                          setFieldValue(`floors[${3}].floorDimension.breath`, "")
                                          setFieldValue(`floors[${3}].floorDimension.height`, "")

                                          setFieldValue(`availableSpaces[${3}].availableSpaceDimension.length`, "")
                                          setFieldValue(`availableSpaces[${3}].availableSpaceDimension.breath`, "")
                                          setFieldValue(`availableSpaces[${3}].availableSpaceDimension.height`, "")
                                        }
                                      }}
                                      value={!secondFloorCheck} checked={secondFloorCheck} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck4" disabled={values.storageType === "palletposition" || viewMood} />
                              ...
                              <tr className='border'>
                                <p className="my-2 text-nowrap">Total Area({values.floors ? values.floors[0].unit === "FEET" ? "sqft" : "" : ""}
                              ...
                              <tr>
                                <td className="w-100px py-1">
                                  <p className="mb-0 w-130px">Racks (Slotted Angle) - No of Bins:</p>
                                </td>
                                <td className="col-auto form-group py-3 mb-0 d-flex border-0">
                                  <div className="form-check common-radio-deep-blue mx-3">
                                    ...
                                    <label className="common-radio-deep-blue-label pl-2" htmlFor="racksSlotted">Yes</label>
                                  </div>
                                  <div className="form-check common-radio-deep-blue mx-3">
                                    ...
                                    <label className="common-radio-deep-blue-label pl-2" htmlFor="racksSlotted1">No</label>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                <td className="col-auto form-inline form-group py-3 mb-0">
                                  <div className="form-check common-radio-deep-blue mx-3 border-0">
                              ...
                              <tr>
                                ...
                                <td className="col-auto py-1"></td>
                                <td className="w-150px py-1"  colSpan="2">
                              ...
                              <tr>
                                ...
                                <td className="col-auto form-inline form-group mt-1 mb-0 py-1 border-0  ">
                                  <div className="form-check common-radio-deep-blue mx-3">
                        ...
                        <div className="col-12 border-0 border-bottom-0 table-responsive table-collapse">
                          <table className="table">
                            <tbody>
                              <tr>
                                <td className="w-160px py-1">
                                  <p className="my-2">Available Space(in ft): <sup className="text-danger">*</sup></p>
                                </td>
                                <td className="col-auto py-1"></td>
                                <td className="col-auto py-1"></td>
                                <td className="w-150px py-1">
                                  <div className="common-checkbox-deep-blue2 position-relative mx-auto d-inline-block">
                                    <input disabled={values.storageType === "palletposition" || viewMood || true} name="basementCheck1" onChange={(e) => handleCheck1(e)} value={!basementCheck1} checked={basementCheck1} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck100" />
                                    <label className="common-checkbox-deep-blue2-label pl-4 mr-3" htmlFor="defaultCheck100">Basement
                                    </label>
                                  </div>
                                </td>
                                <td className="w-150px text-nowrap py-1">
                                  <div className="common-checkbox-deep-blue2 position-relative mx-auto d-inline-block">
                                    <input name="groundFloorCheck1" onChange={(e) => handleCheck1(e)} value={!groundFloorCheck1} checked={groundFloorCheck1} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck200" disabled={values.storageType === "palletposition" || viewMood || true} />
                                ...
                                <td className="w-150px text-nowrap py-1">
                                  <div className="common-checkbox-deep-blue2 position-relative mx-auto d-inline-block">
                                    <Field name="firstFloorCheck1" onChange={(e) => handleCheck1(e)} value={!firstFloorCheck1} checked={firstFloorCheck1} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck300" disabled={values.storageType === "palletposition" || viewMood || true} />
                                ...
                                <td className="w-150px text-nowrap py-1">
                                  <div className="common-checkbox-deep-blue2 position-relative mx-auto d-inline-block">
                                    <Field name="secondFloorCheck1" onChange={(e) => handleCheck1(e)} value={!secondFloorCheck1} checked={secondFloorCheck1} className="common-checkbox-deep-blue2-input" type="checkbox" id="defaultCheck400" disabled={values.storageType === "palletposition" || viewMood || true} />
                              ...
                              <tr className="border">
                                <p className="my-0">Total Available Space({values.availableSpaces ? values.availableSpaces[0].unit === "FEET" ? "sqft" : "" : ""}
                        ...
                        <div className={`col-12 mt-2 ${viewMood ? 'd-none' : ""}`}>
                          <div className="row justify-content-end">
                            ...
                            {floorError && <span className="errorMsg">{floorError}</span>}
                            ...
                            <div className="col-auto">
                              <button type="submit" disabled={data.isPending} className="px-5 btn btn-deep-blue add-className remove-className">Save
