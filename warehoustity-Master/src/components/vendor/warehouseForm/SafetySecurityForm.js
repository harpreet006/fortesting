...
const SafetySecurityForm = ({ viewMood }) => {
  ...
  const handleValidation = () => {
    ...
    if (fireABCYes === "yes" && new Date(safetyForm.fireABCTill) < new Date(safetyForm.fireABCFrom)) {
      isError = false;
      errors['fireABCTill'] = "Valid Till Date Invalid";
    }
    ...
    if (fireCO2Yes === "yes" && new Date(safetyForm.fireCO2Till) < new Date(safetyForm.fireCO2From)) {
      isError = false;
      errors['fireCO2Till'] = "Valid Till Date Invalid";
    }
    ...
    if (fireOtherYes === "yes" && new Date(safetyForm.fireOtherTill) < new Date(safetyForm.fireOtherFrom)) {
      isError = false;
      errors['fireOtherTill'] = "Valid Till Date Invalid";
    }
    ...
    // }
    if (safetyForm.others.length > 0 && (/^[\w .,!?()]+$/).test(safetyForm.others) === false) {
      isError = false
      errors["others"] = "Please Enter Valid"
    }
    setErrors(errors)
    return isError;
  }
                ...
                <div className="row bg-white rounded mx-0 col-xxxl-11">
                      ...
                      <tbody>
                        <tr className="border">
                          <td className="mw-200px">
                            <p className="mb-0">Fire Extinguisher (ABC):</p>
                          </td>
                          ...
                          <td className="pb-4">
                            <input type="number" name="fireABCQty" value={fireABCQty} onChange={(e) => HandleChange(e)} disabled={fireABCYes === "no"} className="form-control form-control-sm bg-white px-1 mb-1 mt-3 text-center" placeholder="Qty" style={{ width: "50px" }} readOnly={viewMood} />
                          ...
                          <td className="pb-4">
                            ...
                            <input type="date" name="fireABCFrom" value={readableDate(fireABCFrom ? fireABCFrom : "")} onChange={(e) => HandleChange(e)} disabled={fireABCYes === "no"} className="form-control form-control-sm bg-white px-4 mb-2" placeholder="" readOnly={viewMood} />
                          ...
                          <td className="pb-4">
                            ...
                            <input type="date" name="fireABCTill" value={readableDate(fireABCTill ? fireABCTill : "")} onChange={(e) => HandleChange(e)} disabled={fireABCYes === "no"} className="form-control form-control-sm bg-white px-4 " placeholder="" readOnly={viewMood} />
                            <span className="errorMsg">{fireABCYes === "no" ? null : errors["fireABCTill"]}</span>
                          </td>
                        </tr>
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Fire Extinguisher (CO2):</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline py-4 w-200px mt-3 mb-0 border-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1">
                            <input type="number" name="fireCO2Qty" value={fireCO2Qty} onChange={(e) => HandleChange(e)} disabled={fireCO2Yes === "no"} className="form-control form-control-sm bg-white px-1 mb-1 mt-3 text-center" placeholder="Qty" style={{ width: "50px" }} readOnly={viewMood} />
                            <span className="errorMsg">{fireCO2Yes === "no" ? null : errors["fireCO2Qty"]}</span>
                          </td>
                          <td className="py-1">
                            <label htmlFor="" className="mb-0 px-4 small text-uppercase">Valid from</label>
                            <input type="date" name="fireCO2From" value={readableDate(fireCO2From ? fireCO2From : "")} onChange={(e) => HandleChange(e)} disabled={fireCO2Yes === "no"} className="form-control form-control-sm bg-white px-4 mb-2" placeholder="" readOnly={viewMood} />
                            <span className="errorMsg">{fireCO2Yes === "no" ? null : errors["fireCO2From"]}</span>
                          </td>
                          <td className="py-1">
                            <label htmlFor="" className="mb-0 px-4 small text-uppercase">Valid till</label>
                            <input type="date" name="fireCO2Till" value={readableDate(fireCO2Till ? fireCO2Till : "")} onChange={(e) => HandleChange(e)} disabled={fireCO2Yes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="" readOnly={viewMood} />
                            <span className="errorMsg">{fireCO2Yes === "no" ? null : errors["fireCO2Till"]}</span>
                          </td>
                        </tr>
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Fire Extinguisher (Others):</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline py-4 w-200px mt-3 mb-0 border-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1">
                            <input type="number" name="fireOtherQty" value={fireOtherQty} onChange={(e) => HandleChange(e)} disabled={fireOtherYes === "no"} className="form-control form-control-sm bg-white px-1 mb-1 mt-3 text-center" placeholder="Qty" style={{ width: "50px" }} readOnly={viewMood} />
                            <span className="errorMsg">{fireOtherYes === "no" ? null : errors["fireOtherQty"]}</span>
                          </td>
                          <td className="py-1">
                            <label htmlFor="" className="mb-0 px-4 small text-uppercase">Valid from</label>
                            <input type="date" name="fireOtherFrom" value={readableDate(fireOtherFrom ? fireOtherFrom : "")} onChange={(e) => HandleChange(e)} disabled={fireOtherYes === "no"} className="form-control form-control-sm bg-white px-4 mb-2" placeholder="" readOnly={viewMood} />
                            <span className="errorMsg">{fireOtherYes === "no" ? null : errors["fireOtherFrom"]}</span>
                          </td>
                          <td className="py-1">
                            <label htmlFor="" className="mb-0 px-4 small text-uppercase">Valid till</label>
                            <input type="date" name="fireOtherTill" value={readableDate(fireOtherTill ? fireOtherTill : "")} onChange={(e) => HandleChange(e)} disabled={fireOtherYes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="" readOnly={viewMood} />
                            <span className="errorMsg">{fireOtherYes === "no" ? null : errors["fireOtherTill"]}</span>
                          </td>
                        </tr>
                        <tr className="border">
                          <td className="mw-200px">
                            <p className="mb-0">Fire Sprinklers:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline mt-2 mb-0 border-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="fireSprinklers" value={fireSprinklers} onChange={(e) => HandleChange(e)} disabled={fireSprinklersYes === "no"} className="form-control form-control-sm bg-white px-4 " placeholder="Qty" readOnly={viewMood} />
                        ...
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Fire Hydrant:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline mt-2 mb-0 border-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="fireHydrant" value={fireHydrant} onChange={(e) => HandleChange(e)} disabled={fireHydrantYes === "no"} className="form-control form-control-sm bg-white px-4 " placeholder="Qty" readOnly={viewMood} />
                        ...
                        <tr className="border">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="cctv" onChange={(e) => HandleChange(e)} disabled={cctvYes === "no"} value={cctv} className="form-control form-control-sm bg-white px-4 " placeholder="Qty" />
                        ...
                        <tr clsasName="border">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="waterQty" value={waterQty} onChange={(e) => HandleChange(e)} disabled={waterYes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="Qty" readOnly={viewMood} />
                            <span className="errorMsg">{waterYes === "no" ? null : errors["waterQty"]}</span>
                          </td>
                          <td className="py-1">
                            <input type="number" name="waterLiter" value={waterLiter} onChange={(e) => HandleChange(e)} disabled={waterYes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="Total Storage in Liter" readOnly={viewMood} />
                            <span className="errorMsg">{waterYes === "no" ? null : errors["waterLiter"]}</span>
                          </td>
                        </tr>
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Smoke Detectors / Fire Alarm:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline border-0 mt-2 mb-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="smoke" value={smoke} onChange={(e) => HandleChange(e)} disabled={smokeYes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="Qty" readOnly={viewMood} />
                        ...
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Security Guard:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline border-0 mt-2 mb-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1" colSpan="2">
                            <input type="number" name="security" value={security} onChange={(e) => HandleChange(e)} disabled={securityYes === "no"} className="form-control form-control-sm bg-white px-4" placeholder="Qty" readOnly={viewMood} />
                        ...
                        <tr className="border">
                          <td className="mw-200px">
                            <p className="mb-0">Metal Detector:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline border-0 mt-2 mb-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-0" colSpan="2">
                            <input type="number" name="metal" value={metal} onChange={(e) => HandleChange(e)} disabled={metalYes === "no"} className="form-control form-control-sm bg-white px-4 " placeholder="Qty" readOnly={viewMood} />
                        ...
                        <tr className='border'>
                          <td className="mw-200px">
                            <p className="mb-0">Pest Control:</p>
                          </td>
                          <td className="col-auto form-inline form-group form-inline border-0 mt-2 mb-0">
                            <div className="form-check common-radio-deep-blue mx-3">
                          ...
                          <td className="py-1" colSpan="2">
                            ...
                            <input type="date" name="pest" value={readableDate(pest ? pest : "")} onChange={(e) => HandleChange(e)} disabled={pestYes === "no"} className="form-control form-control-sm bg-white px-4" readOnly={viewMood} />
                        ...
                        <tr>
                          ...
                          <td className="" colSpan="4">
                            <textarea type="text" name="others" value={others} onChange={(e) => HandleChange(e)} className="form-control form-control-sm bg-white px-4 rounded-sm" placeholder="" rows="3" readOnly={viewMood}></textarea>
                  ...
                  <div className={`col-12 mt-1 ${viewMood ? 'd-none' : ''}`}>
                    <div className="row justify-content-end">
                      ...
                      <div className="col-auto">
                        <button type="submit"  className="btn btn-deep-primary add-className remove-className px-5 ">Save
